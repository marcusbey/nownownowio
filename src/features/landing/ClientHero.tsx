        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          >
            ...
            <p className="max-w-xl text-xl text-slate-300">
              Transform visitors into loyal customers by sharing your progress as it happens. Create authentic connections and watch your conversion rates soar with real-time updates that resonate.
            </p>
          </motion.div>
