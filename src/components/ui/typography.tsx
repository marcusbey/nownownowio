...
export const typographyVariants = cva("", {
  variants: {
    variant: {
      ...
      h4: "scroll-m-20 font-caption text-lg font-semibold tracking-tight",
...
type TVariant = TypographyCvaProps["variant"];
type TAs = ElementType;

type ElementTypeForVariant<T extends NonNullable<TVariant>> = ElementMapping[T];
...
// @returns
function InnerTypography<
  TVariant extends TypographyCvaProps["variant"],
...
ref: ForwardedRef<any>) {
  const Component = (as ??
    defaultElementMapping[variant as keyof ElementMapping]) as ElementType;
