...
const clientSchema = z.object({
  ...
  // Stripe Price IDs
  NEXT_PUBLIC_STRIPE_FREEBIRD_MONTHLY_PRICE_ID: z.string().min(1).optional(),
  NEXT_PUBLIC_STRIPE_FREEBIRD_YEARLY_PRICE_ID: z.string().min(1).optional(),
  NEXT_PUBLIC_STRIPE_FREEBIRD_LIFETIME_PRICE_ID: z.string().min(1).optional(),
