...
export const env = createEnv({
  server: {
    ...
    STRIPE_SECRET_KEY_TEST: z.string().default('sk_test_default'),
  ...
  client: {
    ...
    NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY_TEST: z.string().default('pk_test_default'),
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY_TEST: process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY_TEST || 'pk_test_default',
